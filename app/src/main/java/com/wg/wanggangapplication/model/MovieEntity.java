package com.wg.wanggangapplication.model;
...
public class MovieEntity {
    ...
    private List<SubjectsTestBean> subjects;
    ...
    public List<SubjectsTestBean> getSubjects() {
        return subjects;
    }

    public void setSubjects(List<SubjectsTestBean> subjects) {
        this.subjects = subjects;
    }

    public static class SubjectsTestBean {
        /**
         * max : 10
         * average : 9.6
         * stars : 50
        ...
        private List<CastsTestBean> casts;
        /**
        ...
        private List<DirectorsTestBean> directors;

        public RatingTestBean getRating() {
            return rating;
        }

        public void setRating(RatingTestBean rating) {
            this.rating = rating;
        }
        ...
        public ImagesTestBean getImages() {
            return images;
        }

        public void setImages(ImagesTestBean images) {
            this.images = images;
        }
        ...
        public List<CastsTestBean> getCasts() {
            return casts;
        }

        public void setCasts(List<CastsTestBean> casts) {
            this.casts = casts;
        }

        public List<DirectorsTestBean> getDirectors() {
            return directors;
        }

        public void setDirectors(List<DirectorsTestBean> directors) {
            this.directors = directors;
        }

        public static class RatingTestBean {
            private int max;
        ...
        public static class ImagesTestBean {
        ...
        public static class CastsTestBean {
            private String alt;
            /**
            ...
            private AvatarsTestBean avatars;
            private String name;
            private String id;
            ...
            public AvatarsTestBean getAvatars() {
                return avatars;
            }

            public void setAvatars(AvatarsTestBean avatars) {
            ...
            public static class AvatarsTestBean {
                private String small;
                private String large;
                private String medium;
        ...
        public static class DirectorsTestBean {
            private String alt;
            /**
